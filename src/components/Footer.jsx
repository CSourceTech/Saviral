    ...
    <footer className="bg-slate-100 py-8 sm:py-12 lg:py-16 px-4 sm:px-6 lg:px-10 border-t mt-4 border-gray-200">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        <div className="space-y-4">
          <h3 className="text-xl sm:text-2xl font-semibold text-green-600">Saviral <span className="font-normal text-gray-700"> </span></h3>
          <p className="uppercase text-xs sm:text-sm text-gray-500">ORGANIC STORE</p>
          <div className="w-12 h-0.5 bg-green-600"></div>
          <p className="text-sm text-gray-600">Welcome To The Saviral Store</p>
        ...
        <div className="mt-8 sm:mt-0">
          <h3 className="text-lg font-semibold text-gray-700 mb-4">The Saviral Information</h3>
      ...
      <div className="max-w-7xl mx-auto mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-gray-200 flex flex-col sm:flex-row justify-between items-center text-xs sm:text-sm text-gray-700">
        <p className="text-center sm:text-left mb-4 sm:mb-0">©2024 The Saviral , made with <span className="text-red-500">❤️</span> by Campaigning Source, all right reserved</p>
